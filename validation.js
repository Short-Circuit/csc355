function account_create_validate() {
	...
	if (!(document.AccountForm.email.value.includes("@")) || !(document.AccountForm.email.value.includes(".")) || document.AccountForm.email.value.indexOf("@") == 0 || document.AccountForm.email.value.indexOf("@") > document.AccountForm.email.value.indexOf(".")) {
	...
	if (!(document.AccountForm.pass_check.value == document.AccountForm.pass.value)) {
		alert("Make sure that the passwords match");
		document.AccountForm.pass_check.focus();
		return false;
	}
	return true;
}
...
function create_playlist_validate() {
	...
	if (document.CreateForm.track1.value == "" && document.CreateForm.track2.value == "" && document.CreateForm.track3.value == "" && document.CreateForm.track4.value == "" && document.CreateForm.track5.value == "") {
